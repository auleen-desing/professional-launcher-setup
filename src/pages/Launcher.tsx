  ...
  return (
    ...
    >
      ...
      <footer className="flex items-center justify-between px-6 py-3 bg-black/90 backdrop-blur-sm border-t border-primary/30">
        <a href="/Novaera.exe" download="Novaera.exe" className="text-muted-foreground text-sm hover:text-foreground transition-colors cursor-pointer">Click to download</a>
        ...
        <div className="flex items-center gap-3">
          ...
          <Button 
            ...
            asChild
          >
            <a href="/Novaera.exe" download="Novaera.exe">
